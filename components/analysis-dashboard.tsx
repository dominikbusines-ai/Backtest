...
export function AnalysisDashboard() {
  ...
  const reviewedTrades = useMemo(() => filtered.filter((trade) => trade.review_observation || trade.review_mistake || trade.review_invalidation), [filtered]);
